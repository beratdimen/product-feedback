  ...
  return (
    <div className="listroaditem">
      <div className="listroadItemHeader">
        <h6>{selected === 1 ? "Planned (1)" : selected === 2 ? "In-Progress (1)" : "Live (1)"}</h6>
        <span>Ideas prioritized for research</span>
      </div>
      <div className="listroadItemContent" style={{
        borderTop: selected === 1 ? "6px solid var(--plannedColor)" : selected === 2 ? "6px solid var(--inProgreessColor)" : "6px solid var(--liveColor)"
      }}>
        <p>
          <span style={{
            color: selected === 1 ? "var(--plannedColor)" : selected === 2 ? "var(--inProgreessColor)" : "var(--liveColor)"
          }}>●</span>{selected === 1 ? "Planned" : selected === 2 ? "In-Progress" : "Live"}
        </p>
